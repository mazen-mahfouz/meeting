    ...
    <div class="SecondopinionPage text-center w-full max-w-[1400px] m-auto px-[10px] md:px-[60px] py-[60px]">
      ...
      <ValidationObserver v-slot="{ handleSubmit }">
        <form  @submit.prevent="handleSubmit(onSubmit)" class="space-y-4 md:space-y-6 px-[10px] md:px-[30px] pt-[40px] text-start" action="#">
            ...
            <ValidationProvider name="tests" rules="required" :custom-messages="{required: 'ما هي المجال  !'}" v-slot="{ errors }">
              <h1 class="block mb-2 text-sm font-medium text-gray-900 mt-[30px]"> مجال الاستشارة</h1>
              <span class="text-[red] font-bold text-[12px] m-[5px] my-[20px] block">{{ errors[0] }}</span>
              <div class="w-full flex flex-wrap justify-start items-center gap-[20px]">
                <div class="flex items-center">
                    <input id="tests1" v-model="tests" type="checkbox" value="الجراحة" name="tests" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                    <label for="tests1" class="ms-2 text-sm font-medium text-gray-900">الجراحة</label>
                </div>
                <div class="flex items-center">
                    <input id="tests2" v-model="tests" type="checkbox" value="القلب والأوعية الدموية" name="tests" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                    <label for="tests2" class="ms-2 text-sm font-medium text-gray-900">القلب والأوعية الدموية</label>
                </div>
                <div class="flex items-center">
            ...
            <ValidationProvider name="diseases" rules="required" :custom-messages="{required: 'ما هي طبيعة الموعد !'}" v-slot="{ errors }">
              <h1 class="block mb-2 text-sm font-medium text-gray-900 mt-[30px]"> طبيعة الموعد</h1>
              <span class="text-[red] font-bold text-[12px] m-[5px] my-[20px] block">{{ errors[0] }}</span>
              <div class="w-full flex flex-wrap justify-start items-center gap-[20px]">
                <div class="flex items-center">
                    <input id="tests1" v-model="diseases" type="checkbox" value="حضوري" name="diseases" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                    <label for="tests1" class="ms-2 text-sm font-medium text-gray-900">حضوري</label>
                </div>
                <div class="flex items-center">
                    <input id="tests2" v-model="diseases" type="checkbox" value="بالهاتف" name="diseases" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                    <label for="tests2" class="ms-2 text-sm font-medium text-gray-900">بالهاتف</label>
                </div>
              </div>
            </ValidationProvider>
