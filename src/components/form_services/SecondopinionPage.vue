    ...
    <div class="SecondopinionPage text-center w-full max-w-[1400px] m-auto px-[10px] md:px-[60px] py-[60px]">
      ...
      <ValidationObserver v-slot="{ handleSubmit }">
        <form  @submit.prevent="handleSubmit(onSubmit)" class="space-y-4 md:space-y-6 px-[10px] md:px-[30px] pt-[40px] text-start" action="#">
            ...
            <ValidationProvider name="diseases" rules="required" :custom-messages="{required: 'ما هي الامراض !'}" v-slot="{ errors }">
              <h1 class="block mb-2 text-sm font-medium text-gray-900 mt-[30px]"> الفحوصات التي تم إجراؤها</h1>
              <span class="text-[red] font-bold text-[12px] m-[5px] my-[20px] block">{{ errors[0] }}</span>
              <div class="w-full flex flex-wrap justify-start items-center gap-[20px]">
                <div class="flex items-center">
                    <input id="tests1" v-model="diseases" type="checkbox" value="الأشعة المقطعية" name="diseases" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                    <label for="tests1" class="ms-2 text-sm font-medium text-gray-900">الأشعة المقطعية</label>
                </div>
                <div class="flex items-center">
                    <input id="tests2" v-model="diseases" type="checkbox" value="الأشعة السينية" name="diseases" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                    <label for="tests2" class="ms-2 text-sm font-medium text-gray-900">الأشعة السينية</label>
                </div>
                <div class="flex items-center">
                    <input id="tests1" v-model="diseases" type="checkbox" value="تخطيط القلب" name="diseases" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                    <label for="tests1" class="ms-2 text-sm font-medium text-gray-900">تخطيط القلب</label>
                </div>
                <div class="flex items-center">
                    <input id="tests2" v-model="diseases" type="checkbox" value="الموجات فوق الصوتية" name="diseases" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                    <label for="tests2" class="ms-2 text-sm font-medium text-gray-900">الموجات فوق الصوتية</label>
                </div>
                <div class="flex items-center">
                    <input id="tests1" v-model="diseases" type="checkbox" value="تصوير الأوعية الدموية" name="diseases" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                    <label for="tests1" class="ms-2 text-sm font-medium text-gray-900">تصوير الأوعية الدموية</label>
                </div>
                <div class="flex items-center">
                    <input id="tests2" v-model="diseases" type="checkbox" value="الرنين المغناطيسي" name="diseases" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                    <label for="tests2" class="ms-2 text-sm font-medium text-gray-900">الرنين المغناطيسي</label>
                </div>
              </div>
            </ValidationProvider>
